...
PACKAGENAME = metadata.get('package_name', 'sdss_catl_utils')
DESCRIPTION = metadata.get('description', 'Repository for SDSS DR7 catalogues package')
...
if sys.version_info < tuple((int(val) for val in __minimum_python_version__.split('.'))):
    sys.stderr.write("ERROR: sdss_catl_utils requires Python {} or later\n".format(__minimum_python_version__))
    sys.exit(1)
